...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($produk_id)) {
        ...
        if (mysqli_query($koneksi, $query_transaksi)) {
            $transaksi_id = mysqli_insert_id($koneksi); // Ambil ID Nota Baru
            ...
            if(mysqli_query($koneksi, $query_detail)) {
                ...
                // 4. Update Stok (Hanya jika detail berhasil disimpan)
                ...
                // PERBAIKAN DI SINI:
                // Jika detail gagal, tampilkan error MySQL-nya
                $error_db = mysqli_error($koneksi);
                $error_message = "Gagal menyimpan detail transaksi: $error_db";

                // ROLLBACK MANUAL: Hapus nota transaksi yang sudah terlanjur dibuat agar tidak jadi sampah
    ...
    <div class="container mt-5">
        ...
        <div class="card p-4 shadow border-0">
            ...
            <form method="POST" action="transaksi_penjualan.php">
                ...
                <div class="alert alert-info py-2" id="detail_info">
                    Harga: Rp 0 | Stok Tersedia: 0
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text text-danger fw-bold" id="stok_error" style="display:none;">
                        Kuantitas melebihi stok yang tersedia!
                    </div>
                </div>

                <div class="mb-4 p-3 bg-light rounded text-end">
